...
* [Computer Graphics from scratch](http://gabrielgambetta.com/computer-graphics-from-scratch) - Gabriel Gambetta (🚧 *in process*)
...
* [Learn Computer Graphics From Scratch!](https://www.scratchapixel.com/) - Scratchapixel (🚧 *in process*)
* [Learn OpenGL](http://learnopengl.com/) - Joey de Vries
* [Learn OpenGL RS](https://github.com/bwasty/learn-opengl-rs) - Benjamin Wasty et al. (🚧 *in process*) (Rust)
...
* [Vulkan Tutorial RS](https://github.com/bwasty/vulkan-tutorial-rs) - Benjamin Wasty et al. (🚧 *in process*) (Rust)
...
* [Cloud Computing for Science and Engineering](https://cloud4scieng.org/chapters/) - Ian Foster, Dennis B. Gannon (🚧 *in process*)
...
* [Computer Science I - Draft](https://bitbucket.org/chrisbourke/computersciencei/src) - Dr. Chris Bourke (PDF) (🚧 *in process*)
* [Computer Science II - Draft](http://cse.unl.edu/~cbourke/ComputerScienceTwo.pdf) - Dr. Chris Bourke (PDF) (🚧 *in process*)
...
* [Linear Algebra](http://home.iitk.ac.in/~arlal/book/la.pdf) - Dr. Arbind K Lal, Sukant Pati (PDF) (🚧 *in process*)
...
* [The Joy of Cryptography (2020)](https://web.engr.oregonstate.edu/~rosulekm/crypto/) - Mike Rosulek (PDF) (🚧 *in process*)
...
* [2D Game Development: From Zero To Hero](https://github.com/Penaz91/2DGD_F0TH) (🚧 *in process*)
...
* [How to Make a Computer Operating System](https://github.com/SamyPesse/How-to-Make-a-Computer-Operating-System) (🚧 *in process*)
...
* [Clean Code Developer: An initiative for more professionalism in software development](https://www.gitbook.com/book/ccd_school/clean-code-developer-com/details) (🚧 *in process*)
...
* [High Performance Accelerated Websites](https://thisisyuu.github.io/ebook) - Anshul (HTML) (🚧 *in process*)
* [High Performance Browser Networking](https://hpbn.co/) - Ilya Grigorik
...
* [Getting Started with Arduino products](https://www.arduino.cc/en/Guide) - Official Arduino Documentation (🚧 *in process*)
...
* [Architecting Modern Web Applications with ASP.NET Core and Microsoft Azure (2020)](https://aka.ms/webappebook) - Steve "ardalis" Smith (PDF) (🚧 *in process*)
...
* [Joy of Elixir](https://joyofelixir.com/) - Ryan Bigg (HTML) - [Source](https://github.com/radar/joyofelixir) (🚧 *in process*)
...
* [Magic of CSS](https://adamschwartz.co/magic-of-css/) - Adam Schwartz (HTML) (🚧 *in process*)
...
* [Building Single Page Web Apps with Backbone.js](https://singlepagebook.supportbee.com/) (🚧 *in process*)
...
* [OCaml Scientific Computing](https://ocaml.xyz/book/) - Liang Wang, Jianxin Zhao (HTML) (🚧 *in process*)
...
* [PowerShell Tips to Write By](https://leanpub.com/powershelltips) - Adam Bertram *(Leanpub account or valid email requested)* (🚧 *in process*)
...
* [pandas: powerful Python data analysis toolkit](https://pandas.pydata.org/docs/pandas.pdf) - Wes McKinney and the Pandas Development Team (🚧 *in process*) (PDF)
...
* [Qt5 Cadaques](http://qmlbook.github.io/) - Juergen Bocklage-Ryannel and Johan Thelin (HTML, PDF, ePub) (🚧 *in process*)
...
* [Using Perl 6](https://github.com/perl6/book/) (🚧 *project is dead*)
...
* [Learn Vim (the Smart Way)](https://github.com/iggredible/Learn-Vim) (HTML) (🚧 *in process*)
